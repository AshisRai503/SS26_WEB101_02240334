export default function UploadPage() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="flex">
        <div className="w-[360px] border-dashed border-2 border-gray-300 rounded-md p-6 text-center">
          ...
          <p className="text-xs text-gray-400 mb-5">720x1280 resolution or higher</p>
